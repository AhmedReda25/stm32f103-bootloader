...
A number of commands related to flash memory are supported such as locking, unlocking flash erasing pages...etc.
Most importantly writing to flash and jumping to another location. User app is written at the beginning of page 32 (0x08008000) but any address in flash address space can be chosen.
